#pip install sentence-transformers numpy tiktoken torch torchvision
import sys
import torch
sys.path.append('replace for linux for path to kernal')
import kernal
...
if __name__ == "__main__":
    ...
    print("Original embedding (first 5 dims):", results['original_embeddings'][0][:5])
    print("RoPE embedding (first 5 dims):", results['rope_embeddings'][0][:5])
